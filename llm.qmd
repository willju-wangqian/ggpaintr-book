...
- `ptr_llm_primer()` — the system-prompt preamble that teaches the model the three-level integration model (@sec-intro) and the "call the docs tool before writing code" rule.
