...
If you need any of these, layer them above ggpaintr — a custom source placeholder that wraps an upload and enforces a schema (@sec-custom-consumer-source) — or below it, at the deployment tier.
